...
class ArabicTranslationTest extends DuskTestCase
{
    ...
    public function test_bookings_page_displays_arabic_translations()
    {
    ...
    public function test_vehicles_page_displays_arabic_translations()
    {
        $user = User::factory()->create([
            'name' => 'Admin User',
            'email' => 'admin@example.com',
    ...
    public function test_vehicle_form_displays_arabic_translations()
    {
        $user = User::factory()->create([
            'name' => 'Admin User',
            'email' => 'admin@example.com',
    ...
    public function test_dashboard_widgets_display_arabic_translations()
    {
        $user = User::factory()->create([
            'name' => 'Admin User',
            'email' => 'admin@example.com',
    ...
    public function test_enum_translations_work_correctly()
    {
        $user = User::factory()->create([
            'name' => 'Admin User',
            'email' => 'admin@example.com',
