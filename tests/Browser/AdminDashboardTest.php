...
describe('Admin Dashboard Browser Tests', function () {
    beforeEach(function () {
    ...
    describe('Dashboard Access and Navigation', function () {
        ...
        it('shows correct navigation menu for admin users', function () {
            browse(function ($browser) {
                $browser->loginAs($this->admin)
                    ->visit('/admin')
                    ->assertSee('Vehicles')
    ...
    describe('Dashboard Statistics and Data', function () {
        it('displays correct vehicle statistics', function () {
        ...
        it('displays booking statistics', function () {
    ...
    describe('Quick Actions and Widget Interactions', function () {
        it('can navigate to vehicle management from dashboard', function () {
            browse(function ($browser) {
                $browser->loginAs($this->admin)
                    ->visit('/admin')
        ...
        it('can navigate to booking management from dashboard', function () {
            browse(function ($browser) {
                $browser->loginAs($this->admin)
                    ->visit('/admin')
        ...
        it('can access recent activities widget', function () {
            browse(function ($browser) {
                $browser->loginAs($this->admin)
                    ->visit('/admin')
    ...
    describe('Dashboard Responsiveness and Performance', function () {
        it('loads dashboard within acceptable time', function () {
            ...
            browse(function ($browser) use ($startTime) {
                $browser->loginAs($this->admin)
                    ->visit('/admin')
                    ->assertSee('Dashboard');
        ...
        it('displays correctly on different screen sizes', function () {
            browse(function ($browser) {
                // Desktop view
                $browser->loginAs($this->admin)
                    ->resize(1200, 800)
    ...
    describe('Dashboard Search and Filtering', function () {
        it('can search for vehicles from dashboard', function () {
        ...
        it('can filter dashboard data by date range', function () {
    ...
    describe('Error Handling and Edge Cases', function () {
        it('handles empty dashboard gracefully', function () {
            // Clear all data
            Vehicle::truncate();
            Booking::truncate();
        ...
        it('displays error message when data fails to load', function () {
            browse(function ($browser) {
                $browser->loginAs($this->admin)
                    ->visit('/admin')
    ...
    describe('Real-time Updates and Notifications', function () {
        it('shows notification when new booking is created', function () {
            browse(function ($browser) {
                $browser->loginAs($this->admin)
                    ->visit('/admin');
