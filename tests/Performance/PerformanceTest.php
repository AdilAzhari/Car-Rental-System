...
describe('Performance Tests', function (): void {
    ...
    describe('Database Performance', function (): void {
        it('handles large vehicle dataset efficiently', function (): void {
        ...
        })->skip(fn (): bool => ! extension_loaded('xdebug'));

        it('handles concurrent booking creation', function (): void {
        ...
        it('optimizes search queries', function (): void {
    ...
    describe('Memory Usage', function (): void {
        it('maintains reasonable memory usage during bulk operations', function (): void {
        ...
        it('handles pagination efficiently', function (): void {
    ...
    describe('Stress Testing', function (): void {
        it('handles high concurrent user load', function (): void {
        ...
        it('maintains performance under booking stress', function (): void {
                ...
                foreach ($vehicles->take(5) as $vehicle) {
                    try {
                        Booking::factory()->create([
                            ...
                            'end_date' => now()->addDays(random_int(31, 60)),
                        ]);
                    } catch (\Exception) {
    ...
    describe('API Performance', function (): void {
        it('API endpoints respond within acceptable time', function (): void {
    ...
    describe('Database Query Performance', function (): void {
        it('uses efficient queries for complex operations', function (): void {
            Vehicle::factory(100)->create();
