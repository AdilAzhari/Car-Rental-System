...
describe('Payment Model', function () {
    ...
    it('can have different payment methods', function () {
    ...
    it('can have different payment statuses', function () {
    ...
    it('can store stripe specific fields', function () {
    ...
    it('can store tng specific fields', function () {
    ...
    it('can store cash specific fields', function () {
    ...
    it('can handle payment failures', function () {
