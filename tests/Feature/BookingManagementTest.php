...
describe('Booking Management', function () {
    ...
    describe('Booking Listing', function () {
        it('allows admin to view all bookings', function () {
        ...
        it('allows renter to view only their bookings', function () {
    ...
    describe('Booking Creation', function () {
        it('allows renter to create new booking', function () {
            $bookingData = [
                'vehicle_id' => $this->vehicle->id,
        ...
        it('prevents double booking for same dates', function () {
    ...
    describe('Booking Status Management', function () {
        beforeEach(function () {
        ...
        it('allows admin to update booking status', function () {
            $this->actingAs($this->admin)
        ...
        it('allows owner to confirm bookings for their vehicles', function () {
        ...
        it('allows renter to cancel their own bookings', function () {
            $this->actingAs($this->renter)
                ->patch("/admin/bookings/{$this->booking->id}", [
    ...
    describe('Booking Calendar Integration', function () {
        it('displays bookings in calendar format', function () {
            Booking::factory()->create([
                'vehicle_id' => $this->vehicle->id,
        ...
        it('allows creating bookings from calendar', function () {
            $this->actingAs($this->renter)
    ...
    describe('Booking Payment Status', function () {
        it('tracks payment status separately from booking status', function () {
    ...
    describe('Booking Commission Calculation', function () {
        it('calculates commission amount correctly', function () {
            $booking = Booking::factory()->create([
                'renter_id' => $this->renter->id,
                'vehicle_id' => $this->vehicle->id,
                'total_amount' => 500.00,
    ...
    describe('Booking Soft Deletion', function () {
        it('soft deletes bookings instead of hard deletion', function () {
            $booking = Booking::factory()->create([
                'renter_id' => $this->renter->id,
                'vehicle_id' => $this->vehicle->id
            ]);
