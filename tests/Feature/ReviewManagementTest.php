...
describe('Review Management', function (): void {
    ...
    describe('Review Listing', function (): void {
        it('allows admin to view all reviews', function (): void {
        ...
        it('allows owner to view reviews for their vehicles', function (): void {
        ...
        it('allows renter to view their own reviews', function (): void {
        ...
        it('filters reviews by rating', function (): void {
            Review::factory()->create([
                'vehicle_id' => $this->vehicle->id,
                'rating' => 5,
            ]);
        ...
        it('filters reviews by vehicle', function (): void {
    ...
    describe('Review Creation', function (): void {
        it('allows renter to create review after completed booking', function (): void {
            $reviewData = [
                'booking_id' => $this->completedBooking->id,
                'vehicle_id' => $this->vehicle->id,
                'rating' => 5,
        ...
        it('prevents review creation for non-completed bookings', function (): void {
        ...
        it('prevents duplicate reviews for same booking', function (): void {
            Review::factory()->create([
                'booking_id' => $this->completedBooking->id,
                'vehicle_id' => $this->vehicle->id,
                'renter_id' => $this->renter->id,
    ...
    describe('Review Updates', function (): void {
        beforeEach(function (): void {
        ...
        it('allows renter to update their own review', function (): void {
            $updateData = [
                'rating' => 5,
        ...
        it('prevents renter from updating other renters reviews', function (): void {
        ...
        it('allows admin to update any review', function (): void {
            $updateData = ['rating' => 3];
    ...
    describe('Review Moderation', function (): void {
        ...
        it('allows admin to hide inappropriate reviews', function (): void {
            $this->actingAs($this->admin)
        ...
        it('allows admin to approve hidden reviews', function (): void {
        ...
        it('filters visible reviews in public views', function (): void {
    ...
    describe('Review Analytics', function (): void {
        it('calculates average rating for vehicle', function (): void {
        ...
        it('displays rating distribution', function (): void {
    ...
    describe('Review with Detailed Ratings', function (): void {
        it('creates review with all detailed ratings', function (): void {
            $reviewData = [
                'booking_id' => $this->completedBooking->id,
                'vehicle_id' => $this->vehicle->id,
                'rating' => 4,
    ...
    describe('Review Deletion', function (): void {
        beforeEach(function (): void {
            $this->review = Review::factory()->create([
                'renter_id' => $this->renter->id,
                'vehicle_id' => $this->vehicle->id,
        ...
        it('allows admin to delete any review', function (): void {
            $this->actingAs($this->admin)
        ...
        it('allows renter to delete their own review', function (): void {
            $this->actingAs($this->renter)
                ->delete("/admin/reviews/{$this->review->id}");
        ...
        it('prevents renter from deleting other renters reviews', function (): void {
            $otherRenter = User::factory()->renter()->create();
